...
public class HeartbeatController : MonoBehaviour
{
    ...
    public Text AOutputText;
    public Text VOutputText;
    ...
    IEnumerator Beat() {
        ...
        AOutputText.text = AOutput.ToString();
        VOutputText.text = VOutput.ToString();
    ...
    public void MinusRate()
    {
     ...
     public void Add_A_Rate()
    {
        AOutput++;
    }

     public void Minus_A_Rate()
    {
        AOutput--;
    }

    public void Add_V_Rate()
    {
        VOutput++;
    }

     public void Minus_V_Rate()
    {
        VOutput--;
    }
}
